...
const Chessmith = () => {
  ...
  const layerOne = Array(boardDimension).fill(null).map(() => Array(boardDimension).fill(1)); // Tile Movement Functions
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "grid",
    style: gridStyle
  }, tileList), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("div", null, gameOver ? `Game Over! Score: ${score}` : `Score: ${score}`));
};
